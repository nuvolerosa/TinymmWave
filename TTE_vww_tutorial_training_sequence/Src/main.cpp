...
#define IMAGE1_ADDR 0x08040000
#define IMAGE2_ADDR 0x08048000
#define IMAGE3_ADDR 0x08050000

void SystemClock_Config(void);
void StartDefaultTask(void const *argument);

// signed char => each element is 1 byte
// out_int => vector containing OUTPUT_CH signed chars
// this is a macro, it reserves OUTPUT_CH bytes that are globally accessible
// It stores the probabilities for the labels person/no-person that is output from the NN
signed char out_int[OUTPUT_CH];

// this function invoke training
// WHY labels is so long? we are doing binary classification
...
// this function invoke inference
...
// macros containing the dimensions of the image
#define RES_W 128
#define RES_H 120
...
//    if (t_mode == 1) {
//
//        // Reset the left area on the display to be black
//    	drawBlackBackground(270, 481, 1, 273);
//
